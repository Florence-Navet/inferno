...
MemSample MetricsParser::parseMemSample(const std::vector<uint8_t>& input, std::size_t& offset) {
  MemSample mem;
...
CpuSample MetricsParser::parseCpuSample(const std::vector<uint8_t>& input, std::size_t& offset) {
  CpuSample cpu;
